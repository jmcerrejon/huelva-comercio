...
android() {
    ...
    appc run --project-dir "/Users/ulysess/Documents/Appcelerator/ceca" --log-level info --platform android --color --no-prompt --target dist-playstore --sdk "9.3.2.GA" --output-dir "/Users/ulysess/Documents/Appcelerator/ceca/dist" --keystore "/Users/ulysess/Documents/Appcelerator/ceca/cert/android/com.soporttec.ceca.jks" --alias ceca --store-password "cecaxyz77"
    echo "
Remember update the version of the app on tiapp.xml
"
}
